...
docker run --rm -w /work --cpus 2 -it -v "$RUN_DIR/..":/work -v "$TMP":/corpus --privileged my/qsym sh -c "FUZZER=$FUZZER CORPUS=$CORPUS TSTAMP=$TSTAMP /work/script/campaign-qsym.sh"
